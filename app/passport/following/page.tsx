    ...
    <div className="px-4 py-6 max-w-2xl mx-auto w-full pb-24">
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          ...
          {!loading && <p className="text-white/40 text-sm">{following.length} {following.length === 1 ? 'person' : 'people'}</p>}
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="glass p-10 text-center">
          ...
          <p className="text-white font-bold mb-1">Not following anyone yet</p>
          <p className="text-white/40 text-sm mb-5">Find people in the comments of events you love</p>
          <Link href="/events"
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-white/30 text-xs mt-0.5">
                    {title} · {earnedStamps} stamp{earnedStamps !== 1 ? 's' : ''}
                  </p>
                </div>
